...
export class EditPropertyComponent implements OnInit {
  ...
  public getPropertyById(id){
    this.appService.getPropertyById(id).subscribe(data=>{
      console.log(data)
      this.property = data.value[0];

      this.submitForm.controls.basic.get('title').setValue(this.property.ListingId);
      this.submitForm.controls.basic.get('desc').setValue("This is description");
      this.submitForm.controls.basic.get('priceDollar').setValue((this.property.MBR_CurrentPrice)?this.property.MBR_CurrentPrice:this.property.MBR_CurrentPrice);
      this.submitForm.controls.basic.get('priceEuro').setValue((this.property.MBR_CurrentPrice)?this.property.MBR_CurrentPrice:this.property.MBR_CurrentPrice);
  ...
  onSubmitForm(form){
    if(this.submitForm.get(form).valid){
      this.nextStep();
      if(form == "media"){
        this.snackBar.open('The property "' + this.property.ListingId + '" has been updated.', '×', {
