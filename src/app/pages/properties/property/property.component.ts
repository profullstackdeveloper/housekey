...
export class PropertyComponent implements OnInit {
  ...
  ngOnInit() {
    const listingId = this.dataService.listingId
    console.log('property Componet : ', listingId)
    this.sub = this.activatedRoute.params.subscribe(params => {   
      this.getPropertyById(listingId); 
    });
  ...
  public getRelatedProperties(){
    this.appService.getRelatedProperties().subscribe(properties=>{
      // for demo
      this.relatedProperties = properties.value.slice(0, 4);
    })
  }
  ...
  public getFeaturedProperties(){
    this.appService.getFeaturedProperties().subscribe(properties=>{
      ...
      this.featuredProperties = properties.value.slice(0,3); 
    })
  } 
